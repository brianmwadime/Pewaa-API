...
handler = (app) ->
  ...
  app.get "/api/v#{apiVersion}/wishlists", authenticate(), (req, res) ->
  ...
  app.post "/api/v#{apiVersion}/wishlists", authenticate(), (req, res) ->
  ...
  app.get "/api/v#{apiVersion}/wishlists/:id", authenticate(), (req, res) ->
  ...
  app.delete "/api/v#{apiVersion}/wishlists/:id", authenticate(), (req, res) ->
  ...
  app.get "/api/v#{apiVersion}/wishlists/:id/gifts", authenticate(), (req, res) ->
